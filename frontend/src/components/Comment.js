...
const Comment = (props) => {
    ...
    <div className="comentario-botones">
      {!cambiarInput ? (
        ...
        <>
          <textarea
            ...
            type="text"
            defaultValue={props.comentario.comentario}
            ref={inputValue}
          />
          <button
            className="boton-editar-check"
            onClick={() =>
              props.editar(
                props.comentario._id,
      ...
      <div className="botones">
        <button
          ...
          onClick={() => setcambiarInput(!cambiarInput)}
        >
          ✏️
        </button>
  ...
  const comentarioValido = usuarioValido ? (
    comentarioDeUsuario
  ) : (
    ...
    <div className="comentarios">
      <div className="datos-usuario">
        <img
          ...
          src={props.comentario.idUsuario.url}
          alt={props.comentario.idUsuario.nombre}
        />
