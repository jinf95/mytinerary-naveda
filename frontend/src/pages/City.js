...
class City extends React.Component {
  ...
  render() {
    ...
    return (
      <>
        <div className="headerCity" id="top">
          {this.props.ciudad && (
            <h1 className="nombre-ciudad">{this.props.ciudad.nombre}</h1>
          )}
          {this.props.ciudad && (
            <img
              src={`/assets/ciudades/${this.props.ciudad.imagen}`}
              alt="city"
        ...
        <div className="main-city d-flex align-items-center flex-column">
          ...
          : this.props.itinerarios 
            ? this.props.itinerarios.map((itinerario) => {
              return (
                <Itinerary itinerario={itinerario} key={itinerario.titulo} />
              );
            })
